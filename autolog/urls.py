...
from .views import (
    home, vehicle_list, vehicle_comparison, lifetime_expense_report, gas_price_report, vehicle_create, vehicle_detail, vehicle_edit, vehicle_delete,
...
urlpatterns = [
    ...
    path("reports/lifetime/", lifetime_expense_report, name="lifetime_expense_report"),
    path("reports/gas-prices/", gas_price_report, name="gas_price_report"),
